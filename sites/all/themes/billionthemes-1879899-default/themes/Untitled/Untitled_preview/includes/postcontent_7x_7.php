<?php
function Untitled_preview_postcontent_7x_7() {
    global $bdnode_content, $bdnode_content_attributes;
?>
    
    <div class="data-control-id-59993 bd-postcontent-7 bd-tagstyles bd-custom-imagestyles content"<?php print $bdnode_content_attributes; ?>>
