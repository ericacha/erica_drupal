<?php
function Untitled_comments_7x_1() {
...
?>
    <div id="comments" class=" bd-comments-1 <?php print $bdcomment_classes; ?>"<?php print $bdcomment_attributes; ?>>
        <?php if ($bdcomment_content['comments'] && $bdcomment_node->type != 'forum'): ?>
            <?php print render($bdcomment_title_prefix); ?>
            <div class=" bd-container-36 bd-tagstyles">
        ...
        <?php Untitled_render_template_from_includes('commentsform_1', array('content' => $bdcomment_content)); ?>
    </div>
<?php }