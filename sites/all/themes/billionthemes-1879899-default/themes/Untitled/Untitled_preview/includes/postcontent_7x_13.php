<?php
function Untitled_preview_postcontent_7x_13() {
    global $bdnode_content, $bdnode_content_attributes;
?>
    
    <div class="data-control-id-572212 bd-postcontent-13 bd-tagstyles content"<?php print $bdnode_content_attributes; ?>>
