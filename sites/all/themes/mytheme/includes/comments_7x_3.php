<?php
function Untitled_comments_7x_3() {
...
?>
    <div id="comments" class=" bd-comments-3 <?php print $bdcomment_classes; ?>"<?php print $bdcomment_attributes; ?>>
        ...
        <?php Untitled_render_template_from_includes('commentsform_3', array('content' => $bdcomment_content)); ?>
    </div>
<?php }