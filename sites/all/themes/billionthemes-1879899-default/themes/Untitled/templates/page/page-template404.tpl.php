...
<body class="<?php if (isset($body_classes) && !empty($body_classes)) { print $body_classes; } if (isset($classes) && !empty($classes)) { print $classes; } ?> bootstrap bd-body-9  bd-pagebackground" <?php if (isset($attributes) && !empty($attributes)) { print $attributes; } ?>>
    <?php
...
?>
		...
		<div class=" bd-stretchtobottom-5 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-3"><div class="bd-sheetstyles bd-contentlayout-3 ">
    <div class="bd-container-inner">
 ...
 <?php Untitled_render_template_from_includes('sidebar_area_6'); ?>
    ...
    <div class=" bd-content-6 clearfix">
    <div class="bd-container-inner">
 ...
 <?php Untitled_render_default_content(); ?>
    </div>
</div>
</div>
