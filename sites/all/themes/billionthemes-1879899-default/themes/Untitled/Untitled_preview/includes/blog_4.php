...
function Untitled_preview_blog() {
    ...
    //$nodes = render($nodes);
?>
    <div class="data-control-id-40141 bd-blog">
        <div class="bd-container-inner">
            
                <?php if ($bdpage_title): ?>
    <?php if (isset($bdpage_title_prefix)) print render($bdpage_title_prefix); ?>
    <h2 class="data-control-id-40018 bd-container-29 bd-tagstyles"><?php print $bdpage_title; ?></h2>
    <?php if (isset($bdpage_title_suffix)) print render($bdpage_title_suffix); ?>
<?php endif; ?>
            <?php Untitled_preview_render_template_from_includes('blogpagination_4'); ?>
            <div class="data-control-id-39986 bd-grid-10">
