<?php
function Untitled_preview_article_7x_5() {
    global $bdnode_node, $bdnode_classes, $bdnode_attributes;
?>
    
    <article id="node-<?php print $bdnode_node->nid; ?>" class="<?php print $bdnode_classes; ?> data-control-id-40062 bd-article-5 clearfix"<?php print $bdnode_attributes; ?>>
        <?php 
