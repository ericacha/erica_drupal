<?php
    function Untitled_preview_sidebar_area_16() {
        ob_start();
?>
...
Untitled_preview_render_template_from_includes('tabsmenu_1', array('tabs' => $bdpage_tabs, 'tabs2' => $bdpage_tabs2)); ?>
    ...
    ?>
        <?php if ($show_column): ?>
            <div class="bd-sidebararea-16-column data-control-id-1123431 bd-flex-vertical bd-flex-fixed <?php echo $additional_classes ?>">
