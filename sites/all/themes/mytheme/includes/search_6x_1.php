...
?>
    ...
    <div class="bd-search-wrapper">
            ...
            <a href="#" class=" bd-icon-37" link-disable="true"></a>
    </div>
</div>
<script>
    (function (jQuery, $) {
...
<?php
        ...
        print preg_replace($pattern, '<form class=" bd-search-3 form-inline"$1'.$output.'$3', $search_box_form);
    endif;
}