...
function Untitled_preview_blog_2() {
    ...
    //$nodes = render($nodes);
?>
    <div class="data-control-id-33963 bd-blog-2">
        <div class="bd-container-inner">
            
                <?php if ($bdpage_title): ?>
    <?php if (isset($bdpage_title_prefix)) print render($bdpage_title_prefix); ?>
    <h2 class="data-control-id-33840 bd-container-26 bd-tagstyles"><?php print $bdpage_title; ?></h2>
    <?php if (isset($bdpage_title_suffix)) print render($bdpage_title_suffix); ?>
<?php endif; ?>
            <?php Untitled_preview_render_template_from_includes('blogpagination_2'); ?>
            <div class="data-control-id-33808 bd-grid-8">
