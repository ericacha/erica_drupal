<?php
function Untitled_article_7x_5() {
    global $bdnode_node, $bdnode_classes, $bdnode_attributes;
?>
    
    <article id="node-<?php print $bdnode_node->nid; ?>" class="<?php print $bdnode_classes; ?>  bd-article-5 clearfix"<?php print $bdnode_attributes; ?>>
        <?php 
