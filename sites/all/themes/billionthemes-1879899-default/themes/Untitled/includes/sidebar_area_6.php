<?php
    function Untitled_sidebar_area_6() {
        ob_start();
?>
        <?php Untitled_render_template_from_includes('breadcrumbs_1'); ?>
    <?php
        $show_column = true;
        $additional_classes = '';
    ...
    ?>
        <?php if ($show_column): ?>
            <div class="bd-sidebararea-6-column  bd-flex-vertical bd-flex-fixed <?php echo $additional_classes ?>">
