...
<body class="<?php if (isset($body_classes) && !empty($body_classes)) { print $body_classes; } if (isset($classes) && !empty($classes)) { print $classes; } ?> bootstrap bd-body-6  bd-pagebackground" <?php if (isset($attributes) && !empty($attributes)) { print $attributes; } ?>>
<?php print $page_top; ?>
<?php print $page; ?>
