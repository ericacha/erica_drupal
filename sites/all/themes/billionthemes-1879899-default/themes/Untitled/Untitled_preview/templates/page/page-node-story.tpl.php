...
<body class="<?php if (isset($body_classes) && !empty($body_classes)) { print $body_classes; } if (isset($classes) && !empty($classes)) { print $classes; } ?> bootstrap bd-body-6 data-control-id-37 bd-pagebackground" <?php if (isset($attributes) && !empty($attributes)) { print $attributes; } ?>>
    <?php
...
?>
		...
		<div class="data-control-id-1187546 bd-stretchtobottom-4 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-6"><div class="bd-sheetstyles bd-contentlayout-6 data-control-id-900">
    <div class="bd-container-inner">
 ...
 <?php Untitled_preview_render_template_from_includes('sidebar_area_5'); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class="data-control-id-1121312 bd-layoutitemsbox-14 bd-flex-wide">
    <div class="data-control-id-25469 bd-content-8 clearfix">
    <div class="bd-container-inner">
 ...
 <?php Untitled_preview_render_template_from_includes('blog_1'); ?>
    </div>
</div>
