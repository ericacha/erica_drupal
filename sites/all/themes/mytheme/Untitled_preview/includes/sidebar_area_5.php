<?php
    function Untitled_preview_sidebar_area_5() {
        ob_start();
?>
        <?php 
    $current_region_content = Untitled_preview_render_template_from_includes('drupalregion_11');
?>
    <?php
        $show_column = true;
        $additional_classes = '';
    ...
    ?>
        <?php if ($show_column): ?>
            <div class="bd-sidebararea-5-column data-control-id-1123429 bd-flex-vertical bd-flex-fixed <?php echo $additional_classes ?>">
