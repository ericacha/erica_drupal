...
<body class="<?php if (isset($body_classes) && !empty($body_classes)) { print $body_classes; } if (isset($classes) && !empty($classes)) { print $classes; } ?> bootstrap bd-body-2 data-control-id-25 bd-pagebackground" <?php if (isset($attributes) && !empty($attributes)) { print $attributes; } ?>>
    <?php
...
?>
		...
		<div class="data-control-id-1187581 bd-stretchtobottom-6 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-2"><div class="bd-sheetstyles bd-contentlayout-2 data-control-id-852">
    <div class="bd-container-inner">
 ...
 <?php Untitled_preview_render_template_from_includes('sidebar_area_5'); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class="data-control-id-1121262 bd-layoutitemsbox-12 bd-flex-wide">
    <div class="data-control-id-40142 bd-content-4 clearfix">
    <div class="bd-container-inner">
